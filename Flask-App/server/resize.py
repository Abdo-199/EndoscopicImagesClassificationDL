...
from circle_stretcher import to_square
from PIL import Image
...
def crop_black_columns(image):
    ...
    for x in range(width):
        # just check the 800 pixels in the middle, so it does't crop the columns where the black pixels are overpowering up and down
...
def to_square_save(image_path, new_path=None, method="elliptical"):
    """turn the circular image in a black frame into square,
    and returns the new imge or saves it"""
